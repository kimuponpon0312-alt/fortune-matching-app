...
export const TENKAN_DESCRIPTIONS: Record<Tenkan, string> = {
  甲: "大地に深く根を下ろし、幾星霜を経ても揺るがぬ大樹のごとく。あなたは周囲を包み込む包容力と、時代を超えて受け継がれる品格を備えています。その存在そのものが、人々に安心と信頼を与える光の柱なのです。",
  乙: "春の風に揺れる可憐な草花のように、あなたは優雅さと繊細さを兼ね備えた調和の象徴。美しいものへの感受性が高く、周囲の空気を瞬時に読み取り、場を美しく整える天賦の才を持っています。",
  丙: "天を照らす太陽のように、あなたは存在するだけで周囲を優しく照らす光の象徴。その輝きは希望を運び、未来への扉を開く推進力となります。あなたの前進する姿は、多くの人に勇気とインスピレーションを与えるのです。",
  丁: "闇夜を優しく照らす灯火のように、あなたは人々の心を温め、希望の光を灯す存在。献身的な愛情と深い共感力で、誰もが安心して寄り添える温かな場所を創り出します。",
  戊: "雄大な山々のように、あなたは動じることのない安定感と威厳を備えています。静かに構えながらも、その存在感は周囲に安心と信頼を与え、すべての基盤となる求心力を放っています。",
  己: "豊かな実りをもたらす大地のように、あなたは現実を着実に形に変える力を持っています。実務の才覚と、価値を育て上げるプロデューサーとしての資質は、周囲から高く評価されるでしょう。",
  庚: "鍛え抜かれた鋼のように、あなたは揺るぎない意志と確かな実行力を持っています。正義感と決断力で道を切り開き、信頼できるリーダーとして多くの人から慕われる存在です。",
  辛: "磨き上げられた宝石のように、あなたは美意識と精度を極めた洗練の象徴。その存在は周囲の質を底上げし、上質な時間と空間を創り出す才能に恵まれています。",
  壬: "果てしなく広がる大海のように、あなたは自由な発想と創造性で境界を越え、無限の可能性を広げる力を持っています。その包容力は、多くの人を魅了し、新しい世界を切り開く原動力となります。",
  癸: "静かに降り注ぐ雨のように、あなたは優しさと思いやりで、枯れた心を潤し、新たな生命を育む力を持っています。変化に柔軟に対応し、調和を整える名手として、周囲から愛される存在です。",
};
...
// 月のメッセージ（十干別）
export const MOON_MESSAGE: Record<Tenkan, string> = {
  甲: "今夜、月はあなたに静かな強さを授けます。長期的な視点で物事を見つめ、焦らずに歩みを進めてください。あなたの根は深く、時間をかけて育まれた信頼は、必ず実を結ぶでしょう。",
  乙: "月の光があなたの優雅さを際立たせます。小さな美しさに目を向け、丁寧に心を込めた時間を過ごしてください。その繊細な感性が、周囲の人々の心に深く響くでしょう。",
  丙: "月はあなたの輝きをさらに高めます。今日は積極的に行動し、あなたの光で周囲を照らしてください。そのエネルギーが、新しい可能性を開く鍵となるでしょう。",
  丁: "月の優しい光が、あなたの温かさを増幅させます。人々の心に寄り添い、静かに支える存在として、深い信頼を築いてください。その献身は、必ず報われるでしょう。",
  戊: "月はあなたの安定感を祝福します。動じることなく、静かに構え、重要な判断を下す時が来ています。あなたの威厳と落ち着きが、周囲に安心を与えるでしょう。",
  己: "月の光が、あなたの実務の才覚を照らします。着実に価値を育て、現実的な成果を積み重ねてください。その努力は、必ず形となって現れるでしょう。",
  庚: "月はあなたの意志の強さを支えます。正義感と決断力で道を切り開き、信念を貫いてください。その勇気ある行動が、多くの人から尊敬されるでしょう。",
  辛: "月の光が、あなたの洗練された美しさを際立たせます。質の高い選択を重ね、上質な時間を過ごしてください。その美意識が、周囲の質を高めるでしょう。",
  壬: "月はあなたの自由な発想を祝福します。境界を越え、創造的な視点で新しい可能性を探求してください。その広い心が、多くの人を魅了するでしょう。",
  癸: "月の優しい光が、あなたの思いやりを深めます。柔軟に変化に対応し、調和を整える時間を大切にしてください。その優しさが、周囲の人々の心を潤すでしょう。",
};
...
export function getFortuneDetails(tenkan: Tenkan): FortuneDetails {
  return {
    ...
    moonMessage: MOON_MESSAGE[tenkan],
  };
}
